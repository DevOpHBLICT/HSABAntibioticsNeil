...

{
    ...
    //        Label l = new Label { HorizontalTextAlignment = Xamarin.Forms.TextAlignment.Center, Text = "Pharmacy", TextColor = Color.FromHex("1760ae"), Font = Font.SystemFontOfSize(20, FontAttributes.Bold) };
            ...
            pages.Add(new Pages
            {
                ...
                FirstLine = "<b>Do not routinely prescribe antibiotics</b> as 90% resolve in 7 days without antibiotics.",
                SecondLine = "Amoxicillin or Erythromycin (penicillin allergy) for 5 days. Consult current BNF for Children for doses.  "
            });
            pages.Add(new Pages
            {
                Area = "Upper Respiratory",
                ...
                FirstLine = "<b>Do not routinely prescribe oral antibiotics</b> and advise use of adequate analgesia.",
            ...
            pages.Add(new Pages
            {
                ...
                Comments = "",
                FirstLine = "<b>Do not routinely prescribe antibiotics</b>. Advise use of adequate analgesia. Only prescribe antibiotics for those at high risk of complications or when acute bacterial sinusitis is suspected. 80% resolve within 14 days without antibiotics.",
            ...
            pages.Add(new Pages
            {
                ...
                FirstLine = "If needed Amoxicillin 500mg TDS for 5 days",
            ...
            pages.Add(new Pages
            {
                ...
                FirstLine = "<b style = 'font-size:50'> If CRB65 score = 0 </b> <br/> Amoxicillin 500mg TDS for 5 days <p style = 'font-size:50' ><b > If CRB65 score = 1 or 2 and patient at home </b> <br/> Amoxicillin 500mg TDS plus Clarithromycin 500mg BD for 7 to 10 days ",
                SecondLine = "<b style = 'font-size:50'>If CRB65 score = 0 </b><br/> Clarithromycin 500mg BD for 5 days (review at 3 day and extend to 7-10 days if poor response)<br/> or  <br/> Doxycycline 200mg stat then 100mg OD for 5 days (review at 3 days and extend to 7-10 days if poor response).<br/><b style = 'font-size:50' > If CRB65 score = 1 or 2 and patient at home </b> <br/> Doxycycline 200mg stat then 100mg OD for 7 to 10 days"
            });
            ...
            {
                Area = "Urinary Tract",
                Infection = "UTI in adults (lower)",
                Comments = "<p> > 65 years men and women: Do not treat or send sample for culture in asymptomatic elderly with positive dipsticks since asymptomatic bacteriuria is very common. Diagnosis and treatment must be based on symptoms. <p> Women (16 to 65 years): <br/> Treat women with severe or >=3 symptoms <br/> Men (16 to 65 years): Consider prostatitis and send MSU. If symptoms are mild or non-specific, use negative dipstick to exclude UTI. <p>Always perform culture in cases of treatment failure.",
                FirstLine = "Nitrofurantoin 100mg BD (MR) or 50mg QDS for 3 days (women) 7 days (men)",
                SecondLine = "Trimethoprim 200mg BD (if GFR<45ml/min) for 3 days (women) 7 days (men) <br/> or <br/> Pivmecillinam 400mg stat then 200mg TDS for 3 days (women) 7 days (men). <br/> (Pivmecillinam may be reported as Mecillinam. It is NOT suitable  if penicillin allergic)."
            });
            ...
            pages.Add(new Pages
            {
                ...
                "Start antibiotics in all with significant bacteriuria, even if asymptomatic. Short-term use of nitrofurantoin is unlikely to cause problems to the foetus.",
                FirstLine = "Nitrofurantoin 100mg BD (MR) or 50mg QDS for 7 days <br/> (Note: Risk of haemolytic effects on the new-born if used in third trimester)",
                SecondLine = "Cefalexin♣ 500mg BD or Amoxicillin 500mg TDS if susceptible for 7 days"
            });
            pages.Add(new Pages
            {
                Area = "Urinary Tract",
            ...
            {
                Area = "Urinary Tract",
                Infection = "UTI with catheter (16 to 65 years)",
                Comments = "DON'T give prophylactic antibiotics for changes of the catheter unless there is a history of symptomatic UTI or trauma due to catheter change. DON'T treat asymptomatic bacteriuria as this is very common in catheterised patients.",
                FirstLine = "Nitrofurantoin 100mg BD (MR) or 50mg QDS for 7 days",
                SecondLine = " Trimethoprim 200mg BD for 7 days"
            });
            ...
            {
                Area = "Urinary Tract",
                Infection = "Lower UTI in children (≤16 years)",
                ...
                "<p style = 'font-size:50' ><b>Children >= 3 months</b> Use positive nitrite to guide. Start antibiotics and send pre-treatment MSU",
                FirstLine = "Trimethoprim or Nitrofurantoin for 3 days. See BNF for doses. Note: Consider tablets as a lower cost option if appropriate.",
                SecondLine = "Cefalexin for 3 days. See BNF for doses. Note: Consider tablets as a lower cost option if appropriate."
            });
            ...
            pages.Add(new Pages
            {
                Comments = "-",
                Area = "Urinary Tract",
                Infection = "Upper UTI in children (≤16 years)",
                FirstLine = "Co-amoxiclav for 7-10 days. See BNF for doses.",
                SecondLine = "Cefalexin for 7-10 days. See BNF for doses."
            });

            string x="";
            if (Device.OS == TargetPlatform.Windows)
            {
                x = "Standby (3 days) or post-coital antibiotics (STAT).<div padding:5px;background-color:#bdd1f6;padding:5px;width=100%;color:#1760ae' > Third line </div><p> Antibiotics prophylaxis (depending on strains). <br/> <p><b>First Line if prophylaxis is given</b> <p> Nitrofurantoin 100mg ON (immediate release) for 3-6 month trial <b>THEN Review</b> <p> <b>Second Line if prophylaxis is given</b> <p> Trimethoprim 100mg ON for 3-6 month trial <b>THEN review</b>";

            }
            else
            {
                x = "Standby (3 days) or post-coital antibiotics (STAT). <p><div  style='font-size:20;font-family:Helvetica;padding:5px;background-color:#bdd1f6;padding:5px;width=100%;color:#1760ae' > Third line </div><p> Antibiotics prophylaxis (depending on strains). <br/> <p><b>First Line if prophylaxis is given</b> <p> Nitrofurantoin 100mg ON (immediate release) for 3-6 month trial <b>THEN Review</b> <p> <b>Second Line if prophylaxis is given</b> <p> Trimethoprim 100mg ON for 3-6 month trial <b>THEN review</b>";
            ...
            pages.Add(new Pages
            {
                Comments = "-",
                Area = "Urinary Tract",
                Infection = "Recurrent UTIs in non-pregnant women over 14 years",
                FirstLine = "Advise simple measures, incl. hydration & analgesia. Cranberry products work for some women, but good evidence is lacking.",
                SecondLine = x
            });
            ...
            {
                Area = "Urinary Tract",
                Infection = "Pyelonephritis (acute 16 to 65 years)",
                Comments = "MSU should always be taken to confirm sensitivity.</b> If no response within 24 hours or there is clinical deterioration, arrange for admission.",
            ...
            pages.Add(new Pages
            {
                ...
                Comments = "<b style = 'font-size:50'>MSU should always be taken to confirm sensitivity.</b>" +
                "<p style = 'font-size:50' > 4 weeks treatment may prevent chronic infection.",
                FirstLine = "Ciprofloxacin♣ 500mg BD for 28 days",
                SecondLine = "Trimethoprim 200mg BD  for 28 days (off label use)"
            });
            ...
            pages.Add(new Pages
            {
                ...
                FirstLine = "Finadxomicin 200mg BD (discuss with microbiologist) for 14 days",
            ...
            pages.Add(new Pages
            {
                ...
                FirstLine = "Due to any sexually transmitted pathogen Ceftriaxone♣ 500mg IM(stat) PLUS Doxycycline 100mg BD for 10 to 14 days",
                SecondLine = "<p style = 'font-size:50'>Under 35 years and/or high risk of sexually transmitted infection (non - gonoccocal)" +
                  "Doxycycline 100mg BD or Ofloxacin♣ 200mg BD for 14 days" +
                   "<p style = 'font-size:50' >Over 35 years and/or low risk of sexually transmitted infection" +
            ...
            pages.Add(new Pages
            {
                ...
                FirstLine = "Metronidazole 400mg BD for 5-7 days or 2g stat",
            ...
            pages.Add(new Pages
            {
                ...
                Comments = "<p style = 'font-size:50'>Use <a href='https://ctu1.phc.ox.ac.uk/feverpain/index.php'>FeverPAIN</a>" +
                 "<p style = 'font-size:50' >Fever in last 24h, Purulence, Attend rapidly under 3d, severely Inflamed tonsils, No cough or coryza). <p><b> Score</b> <p>0-1: 13-18% streptococci, use NO antibiotic strategy; <p>2-3: 34-40% streptococci, use 3 day back-up antibiotic;<p> >4: 62-65% streptococci, use immediate antibiotic if severe, or 48hr short back-up prescription. Always share self-care advice & safety net.",
                FirstLine = "<b>Do not routinely prescribe antibiotics</b> as 90% resolve in 7 days without antibiotics.",
...
{
    Area = "Lower Respiratory",
    Infection = "(HCT) Hospital acquired pneumonia",
    Comments ="",
    FirstLine = "•Mild or onset within 3 days of admission:<br/>" +
"Co-amoxiclav♣ 1.2g tds IV or 625mg po tds 7-10 days" +
"<br/>•Severe or onset over 3 days post admission:<br/>" +
"Piperacillin/tazobactam 4.5g IV tds 7-10 days" +
"<br/><b>If penicillin allergic:</b> Consult Consultant Microbiologist " +
"<br/><b>If MRSA colonised/risk:</b> Consult Consultant Microbiologist ",
                     SecondLine = ""
});
         ...
         "<br/> If <b style = 'font-size:50' > penicillin allergic </b>:  Doxycycline 200mg STAT po then 100mg od for 7 days",
            ...
            pages.Add(new Pages
            {
                ...
                Comments = "<b>If severe and hospital acquired discuss with Consultant Microbiologist.</b>",
                FirstLine = "<b>Community onset or inpatient<4 days</b>: <br/>Amoxicillin 1g tds IV plus metronidazole 400mg po/500mg IV tds 7 days " + 
"<br/>Step down to amoxicillin 500mg po tds and po metronidazole as soon as clinically indicated" +
          "<br/><b>Inpatient>4 days or nursing home resident</b>: Co-amoxiclav 1.2g IV tds or 625mg po tds 7 days"+
                "<br/><b>If allergic to penicillin</b>: Clarithromycin IV/oral 500mg 12 hourly plus metronidazole IV 500mg or oral 400mg 8 hourly",
                SecondLine = "<b>Community onset or inpatient <4 days</b>:<br/>Co-amoxiclav 1.2g IV tds/625mg po tds " +
            "<br/><b>Inpatient>4 days or nursing home resident </b>:<br/>Piperacillin/Tazobactam 4.5g IV tds" 
            });
            ...
            pages.Add(new Pages
            {
                ...
                Comments = "",
                FirstLine = "<p style = 'font-size:50'>Flucloxacillin 500mg QDS for 7 days for clean surgery" +
               "<p style = 'font-size:50' >Or Co-amoxiclav♣ 625mg TDS for 7 days for contaminated abdominal or pelvic surgery",
                SecondLine = "Clarithromycin 500mg BD for 7 days for clean surgery" +
                "<p style = 'font-size:50' > OR" +
                 "<p style = 'font-size:50' > Clarithromycin 500mg BD plus Metronidazole 400mg TDS for 7 days for contaminated abdominal or pelvic surgery" +
                 "<p style = 'font-size:50' ><b>HCT only</b>Teicloplanin 400mg od (after 3 loading doses of 400mg 12 hourly) plus doxycycline 100mg bd 7 days"
            });
            pages.Add(new Pages
            {
                Area = "Skin Infections",
            ...
            pages.Add(new Pages
            {
                ...
                Comments = "Cellulitis – moderate or severe Systemic antibiotics only if clinical evidence of infection or patient is systemically unwell or purulent discharge present <br/> If MRSA suspected then add Teicoplanin 400mg bd every 12 hours for 3 doses then 400mg od for 10 days" +
                ...
                FirstLine = "Flucloxacillin IV 1-2g QDS " +
                  "for 7-10 days depending on clinical decision" +
                   "<p style = 'font-size:50' > If changing from IV, change to oral Flucloxacillin",
                SecondLine = "<b>If allergic to penicillin</b>:" +
                 "Teicoplanin 400mg every 12 hours for 3 doses then 400mg daily 7-10 days depending on clincial decision."                
            });
      ...
      "or if penicillin allergy Clarithromycin 500mg bd for a minimum of 7 days",
            ...
            pages.Add(new Pages
            {
                ...
                Comments = "<b>Note</b><br/>Patients with peripheral neuropathy and or peripheral vascular disease do not always display the normal inflammatory signs of redness, heat and swelling.<br/> For example," +
                ...
                FirstLine = "<p style = 'font-size:50'><b>a) Mild infections:</b><br/>Flucloxacillin 1g qds po. Duration 7-10 days." +
                "<p style = 'font-size:50' ><b> b) Moderate infections:</b><br/>Co-amoxiclav♣ 1.2g IV tds. Duration 7-10 days." +
                "<p style = 'font-size:50' ><b> c) Severe infections:</b><br/>" +
  ...
  "<p style = 'font-size:50' > Contact Consultant Microbiologist" +
   ...
   "<p style = 'font-size:50' > Discuss with local microbiology team"
            ...
            pages.Add(new Pages
            {
                ...
                FirstLine = "Flucloxacillin 2g qds IV. Consider oral switch when clinically appropriate." +
               "<p style = 'font-size:50' > Treat for 4 – 6 weeks with at least 14 days of IV therapy",
                SecondLine = "Penicillin allergy – Teicoplanin 400mg every 12 hours for 3 doses then 400mg daily<p style = 'font-size:50' > Treat for 4–6 weeks with at least 14 days of IV therapy"
            });
            ...
            if (Infections == "Pyelonephritis (acute 16 to 65 years)")
            {
                st = st + "<div  style='font-size:20;font-family:Helvetica;padding:5px;background-color:#bdd1f6;padding:5px;width=100%;color:#1760ae' >For pregnant women </div>" +
                             "<p style='font-size:20;font-family:Helvetica;'>Cefalexin♣ 500mg BD for 10 to 14 days</p>";
            }
            if (FirstLine != null)
            {
           ...
           st = st.Replace("Clarithromycin", "<font color ='green'>Clarithromycin</font>");
            ...
            st = st.Replace("Cefixime", "<font color ='red'>Cefixime</font>");
            st = st.Replace("Cefalexin", "<font color ='red'>Cefalexin</font>");
            st = st.Replace("Vancomycin", "<font color ='green'>Vancomycin</font>");
            st = st.Replace("FIdaxomicin", "<font color ='green'>FIdaxomicin</font>");
            st = st.Replace("Fnadxomicin", "<font color ='green'>FIdaxomicin</font>");
