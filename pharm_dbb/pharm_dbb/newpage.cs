...

{
    ...
    public class newpage : ContentPage
    {
        ...
        public newpage(int i)
        {
               ...
               Principles = Principles + "<li> Always prescribe generically.</li>";
                   Principles = Principles + "<li> Avoid topical antibiotics unless indicated as they can promote resistance.</li>";
                    ...
                    Principles = Principles + "<li> For recurrent or resistant infection, please contact your local microbiologist for advice. </li>";
                                                 ...
                                                 var Restricted_Antibiotics = "<p> These antibiotics are significantly more likely to cause <i>Clostridium difficile</i> associated diarrhoea (CDAD) and are therefore restricted. They are marked by the following symbol: ♣ in the 'Guidance for the management of infection in primary care within Hertfordshire' and include cephalosporins♣, quinolones♣ and co-amoxiclav♣. ";
            ...
            Restricted_Antibiotics = Restricted_Antibiotics + " <li> 2nd line Lower UTI in children</li>";
       ...
       Restricted_Antibiotics = Restricted_Antibiotics + "<li> 1st line in diverticulitis </li>";
        Restricted_Antibiotics = Restricted_Antibiotics + "<li> 1st line in bites (animal or human)</li>";
            Restricted_Antibiotics = Restricted_Antibiotics + "<li>1st line in salivary gland infection (sialadentis)</li>";
            Restricted_Antibiotics = Restricted_Antibiotics + "<li> 1st line in “dirty” post op wound infection</li>";
            Restricted_Antibiotics = Restricted_Antibiotics + "<li> 1st line in UTI in children (upper UTI)</li>";
