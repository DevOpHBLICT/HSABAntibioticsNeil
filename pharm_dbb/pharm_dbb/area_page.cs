    ...
    public class area_page : ContentPage
    {
        ...
        public area_page()
        {
            ...
            var data = new List<GetImage>  {
                ...
                new GetImage("Urinary Tract","urinary.png","<p><b>URINARY TRACT INFECTIONS</b><p> Nitrofurantoin is first line but is contraindicated if eGFR is < 45ml/minute /1.73m <sup> 2 </sup> (In patients with an eGFR of 30 - 44ml / minute/1.73m <sup> 2 </sup> only use if restance and no alternative). <p><b>Empirical antibiotics should be guided by previous microbiology result if available </b></p>"),
